...
class BusinessArticleView extends StatefulWidget {
  ...
  @override
  State<BusinessArticleView> createState() => _BusinessArticleViewState();
}

class _BusinessArticleViewState extends State<BusinessArticleView> {
  @override
  void initState() {
    super.initState();
    fetchArticle();
...
@override
  ...
  Future<void> fetchArticle() async {
    final response = await BusinessArticleApi.fetchArticle();
    setState(() {
      articles = response;
    });
  }
