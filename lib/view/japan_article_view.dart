...
class RefreshProviderForJapanArticles extends ChangeNotifier {
  ...
  void _getMoreList(int nextCount) {
    ...
    max_count = nextCount;
    notifyListeners(); // to notify foodList
  }
}
...
class _JapanArticleViewState extends State<JapanArticleView> {
  ...
  Widget build(BuildContext context) {
    RefreshProviderForJapanArticles refreshProvider =
        context.watch<RefreshProviderForJapanArticles>();
    ...
    return Expanded(
        child: SmartRefresher(
            ...
            child: _showListView(
                context, refreshProvider.articleList, refreshProvider)));
  }
  ...
  Widget _showListView(BuildContext context, List<Article>? articleList,
      RefreshProviderForJapanArticles refreshProvider) {
    Size size = MediaQuery.of(context).size;

    final provider = Provider.of<FavoriteProvider>(context);
    return refreshProvider.articleList.isEmpty
        ? Container()
        : ListView.builder(
